    ...
    <>
      <div className="overflow-clip w-full items-center flex flex-col p-5">
        <div className="flex w-full justify-between">
          <p onClick={() => navigate(-1)} className="hover:cursor-pointer">
            {"< Back"}
          </p>
          <p>
            Number of Students :{" "}
            {subject ? subject.course.students.length : null}
          </p>
        </div>
        ...
        <div className="overflow-x-auto relative shadow-md sm:rounded-lg w-full max-w-4xl">
          <table className="w-full text-sm text-left text-gray-200">
            ...
            <tbody>
              {!subject
                ? null
                : subject.course.students.map((student) => {
                    return (
                      <tr
                        key={student._id}
                        className="border-b bg-gray-700 border-gray-700 hover:bg-gray-500"
                      >
      ...
      >
        <div className="m-4 space-y-4 p-10 flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <input
              className="mb-5 bg-gray-600 py-2 px-4 rounded-md"
              type="text"
              name="studentId"
              id="studentId"
          ...
          <button className="bg-indigo-800 py-2 px-4 active:bg-indigo-900 rounded-md">
            Save
          </button>
        </div>
      </Modal>
