...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`ease-in-out duration-500 flex-none bg-slate-900 h-screen flex flex-col py-2 space-y-8 ${
        isShown ? "w-60" : " w-12"
      }`}
    >
      ...
      <div className="w-full flex flex-none h-8 delay-1000 ease-in-out transition-all bg-inherit">
        <svg
          ...
          strokeWidth={1}
          stroke="currentColor"
          className="h-full hover:text-red-500 hover:cursor-pointer flex-none"
        >
          {isShown ? (
            <path
              strokeLinecap="round"
        ...
        <p
          className={`ease-in-out duration-1000 text-2xl w-full tracking-widest font-normal z-0 ${
            isShown ? "ml-3" : "-translate-x-80"
          }`}
        >
          AMS
        </p>
      ...
      <div className="flex flex-col justify-between h-full w-full bg-slate-900">
        ...
        <button
          ...
          className="flex items-center h-8 hover:text-red-600 w-full bg-slate-900"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1}
            stroke="currentColor"
            className="h-8 flex-none bg-inherit z-30"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <span
            className={`ease-in-out duration-500 ${
              isShown ? "ml-3 text-xl" : "z-0 w-0 -translate-x-80"
            }`}
          >
            Logout
          </span>
